...
const FormSchema = z.object({
  ...
  help: z.enum([
    "Evaluate Greenhill Studios for my company",
    "Learn More",
    "Get a Quote",
    "Other",
  ]),
...
type FormValues = {
  ...
  job_title: string;
  company_name: string;
  help: "Evaluate Greenhill Studios for my company" | "Learn More" | "Get a Quote" | "Other";
  services:
    | "Interior Design"
    | "Social Media Marketing"
    | "UI/UX Design"
  ...
  return (
    <div className=" w-full   md:items-center md:justify-center bg-[#f5f3f0]/40 antialiased bg-grid-white/[0.02] relative overflow-hidden ">
      ...
      <div className="md:flex items-start justify-center md:py-20 px-6">
        <div className="">
          <div className="text-5xl font-medium  w-full md:w-2/3  pb-5 md:text-7xl bg-clip-text text-black">
          ...
          <div
            className="
              ...
              text-black
                    "
          >
            Let&apos;s talk about how GreenHill Studios  can help your team work better.
          </div>
          ...
          {!submitted ? (
            ...
            >
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="items-center justify-center  w-full">
                      <FormLabel className="text-sm bg-clip-text text-black">
                        First name *
                      </FormLabel>
                      <FormControl>
                        <Input {...field} />
                  ...
                  <FormItem className="items-center justify-center w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Social Media Marketing">Renovation</SelectItem>
                ...
                render={({ field }) => (
                  <FormItem className="items-center justify-center  w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        <div className="flex gap-4">
                          <SelectItem value="Evaluate Greenhill Studios for my company">
                            Evaluate GreenHill Studios for my company
                          </SelectItem>
                        </div>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-black ">
                  I agree to Greenhill Studios&apos; sending marketing communications related
                  to Greenhill Studios
                </div>
              </div>
